...
public class F06_Different_encodings extends GenericTest {
    ...
    protected void manipulatePdf(String dest) throws Exception {
        ...
        PdfFont french = PdfFont.createFont(pdfDoc, FONT, "WINANSI", true);
        PdfFont czech = PdfFont.createFont(pdfDoc, FONT, "Cp1250", true);
        PdfFont russian = PdfFont.createFont(pdfDoc, FONT, "Cp1251", true);
