...
public class SimpleTable7 extends GenericTest {
    ...
    protected void manipulatePdf(String dest) throws Exception {
        ...
        PdfFont titleFont = PdfFontFactory.createStandardFont(FontConstants.COURIER_BOLD);
        ...
        PdfFont subtitleFont = PdfFontFactory.createStandardFont(FontConstants.TIMES_ROMAN);
        Paragraph subTitle = new Paragraph("(not to be used for reimbursement of services)");
        subTitle.setFont(subtitleFont).setFontSize(9);
        doc.add(subTitle);

        PdfFont importantNoticeFont = PdfFontFactory.createStandardFont(FontConstants.COURIER);
