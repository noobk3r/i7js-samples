...
////            }
////        });
//        Document doc = new Document(pdfDoc, new PageSize(523, 10000));
//        int paragraphs = 0;
//        while (paragraphs < 30) {
//            doc.add(new Paragraph(String.format("Paragraph %s: %s", ++paragraphs, TEXT)));
//        }
//        doc.getRenderer().setParent(doc.getRenderer());
//        LayoutResult layoutResult =  doc.getRenderer().layout(new LayoutContext(new LayoutArea(0, new Rectangle(523, 10000))));
//
////        IRenderer tableRenderer = doc.createRendererSubTree().setParent(doc.getRenderer());
