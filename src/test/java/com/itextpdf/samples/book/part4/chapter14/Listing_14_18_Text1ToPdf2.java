...
public class Listing_14_18_Text1ToPdf2 extends GenericTest {
    public static final String DEST
            = "./target/test/resources/book/part4/chapter14/Listing_14_18_Text1ToPdf2.pdf";
    public static void main(String args[]) throws IOException {
        new Listing_14_18_Text1ToPdf2().manipulatePdf(DEST);
    }
