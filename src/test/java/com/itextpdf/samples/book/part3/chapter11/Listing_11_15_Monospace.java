...
public class Listing_11_15_Monospace extends GenericTest {
    ...
    protected void manipulatePdf(String dest) throws Exception {
        ...
        PdfFont font2 = PdfFont.createFont(pdfDoc, /*"c:/windows/fonts/cour.ttf*/"./src/test/resources/font/LiberationMono-Regular.ttf",
                PdfEncodings.CP1252, true);
        doc.add(new Paragraph(MOVIE).setFont(font2));
        PdfSimpleFont font3 = (PdfSimpleFont) PdfSimpleFont.createFont(pdfDoc, "./src/test/resources/font/FreeSans.ttf"/*"c:/windows/fonts/arialbd.ttf"*/,
                PdfEncodings.CP1252, true);
