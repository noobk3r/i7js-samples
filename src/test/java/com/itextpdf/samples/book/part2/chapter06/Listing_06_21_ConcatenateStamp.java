...
public class Listing_06_21_ConcatenateStamp extends GenericTest {
    ...
    static public final String DEST = "./target/test/resources/book/part2/chapter06/Listing_06_21_ConcatenateStamp.pdf";
    ...
    public void manipulatePdf(String dest) throws IOException {
        ...
        for (int i = 1; i <= n1; i++) {
            ...
            canvas.saveState().beginText().setFontAndSize(PdfFont.createStandardFont(resultDoc, FontConstants.HELVETICA), 12).
